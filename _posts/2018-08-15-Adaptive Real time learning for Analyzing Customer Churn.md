...
For this blog post example, a sample customer churn dataset is gathered from IBM repository. | [IBM_dataset] (https://www.ibm.com/communities/analytics/watson-analytics-blog/predictive-insights-in-the-telco-customer-churn-data-set/)
